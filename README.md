...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-mail-allowlist.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-mail-allowlist)
...
```bash
php artisan vendor:publish --tag="laravel-mail-allowlist-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-mail-allowlist-views"
```

## Usage

```php
$laravelMailAllowlist = new TobMoeller\LaravelMailAllowlist();
echo $laravelMailAllowlist->echoPhrase('Hello, TobMoeller!');
```
